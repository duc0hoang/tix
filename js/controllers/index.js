...
<p class="news__description">Sau 2 tuần ra mắt, Tiệc Trăng Máu chính thức gia nhập câu lạc bộ phim điện ảnh đạt 100 tỷ đồng doanh thu phòng vé. Dàn ngôi sao “bạc tỷ” của phim cũng lần đầu tiên hội tụ đầy đủ trong một khung hình để ăn mừng thành tích ấn tượng của tác phẩm. </p>
...
<p  class="news__description">Chiều tối ngày 30-10-2020, Ngô Thanh Vân và Studio68 đã chính thức phát động cuộc thi thiết kế trang phục cho siêu anh hùng VINAMAN với tổng giá trị giải thưởng lên đến 60 triệu đồng. </p>
<a href="#" class="news__icon"><i class="fa fa-thumbs-up"></i> 1</a>
<a href="#" class="news__icon"><i class="fa fa-comment-alt"></i> 1</a>
</div>
...
<p class="news__description">Không đi theo lối mòn máu me, hù dọa mà đầu tư khai thác những mảng tối của xã hội trên nền một câu chuyện kinh dị, có sự tham gia của nhà sản xuất đã làm nên thành công của loạt tác phẩm ấn tượng “Get Out”, “Us” hay “BlacKkKlansman”, và còn nhiều lý do khác khiến người yêu phim không thể bỏ lỡ Ante </p>
<a href="#" class="news__icon"><i class="fa fa-thumbs-up"></i> 1</a>
<a href="#" class="news__icon"><i class="fa fa-comment-alt"></i> 1</a>
</div>
<div class="col-4 news__item">
...
<p  class="news__description">Đêm qua theo giờ Việt Nam, hãng phim Warner Bros. đưa ra thông báo chính thức về ngày khởi chiếu cho bom tấn TENET tại các thị trường bên ngoài Bắc Mỹ, trong đó có Việt Nam. </p>
<a href="#" class="news__icon"><i class="fa fa-thumbs-up"></i> 1</a>
<a href="#" class="news__icon"><i class="fa fa-comment-alt"></i> 1</a>
</div>
<div class="col-4 news__item">
<div class="row">
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-9">
                <a class="news__title" href="#">
                    <p class="hiding"> Dàn mỹ nhân trong thế giới điện ảnh của quái kiệt Christopher Nolan </p>
                </a>
            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-9">
                <a  class="news__title" href="#">
                    <p class="hiding"> Truy Cùng Giết Tận - Cuộc tái ngộ của hai 'ông hoàng phòng vé' xứ Hàn </p>
                </a>
            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-9">
                <a class="news__title" href="#">
                    <p class="hiding"> 6 đạo diễn tỉ đô làm nên thành công của những bom tấn đình đám nhất Hollywood </p>
                </a>
            </div>
        </div>
    </div>
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-9">
                <a class="news__title" href="#">
                    <p class="hiding"> Gái Già Lắm Chiêu V – Những cuộc đời vương giả </p>
                </a>
            </div>
        </div>
    </div>
